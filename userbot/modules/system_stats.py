...
async def amireallyalive(alive):
    ...
    output = (
        f"**ㅤㅤㅤㅤ 🌀NF - ＰＲＯＪＥＣＴ🌀**\n"
        f"╔══════════╬════╬══════════╗ \n"
        f"╟⟩⟩ 🤴 • `ᴏᴡɴᴇʀ    :`[NF-UserBot](t.me/pachemild)             ㅤ ║\n"
        ...
        f"╚══════════╬════╬══════════╝ \n"
        f"🔰 : [𝗥𝗘𝗣𝗢-𝙂𝙚𝙚𝙯](https://github.com/nishfu22/NF-UserBot)\n👥 : [NF-Group](t.me/HappyZgameBot)\n👤 : [𝗢𝗪𝗡𝗘𝗥](t.me/pachemild)\n"
    )
    if ALIVE_LOGO:
        try:
            logo = ALIVE_LOGO
...
async def redis(alive):
    ...
    output = (
        ...
        f"╭═───────╼⌘╾───────═ \n"
        f"┃[𝗥𝗲𝗽𝗼](https://github.com/nishfu22/NF-UserBot)  |  [𝗦𝘂𝗽𝗽𝗼𝗿𝘁](t.me/HappyZgameBot)  |  "
        f"[𝗜𝗻𝘀𝘁𝗮𝗴𝗿𝗮𝗺](https://Instagram.com/nishfu_im)\n"
        f"╰═──────╼═⌘═╾───────═")
    if ALIVE_LOGO:
        try:
            logo = ALIVE_LOGO
